  ...
  <div v-if="isAdvanced" class="p-fileupload p-fileupload-advanced p-component">
    ...
    <div
      ...
      <slot
        ...
        :files="files"
        :uploaded-files="uploadedFiles"
        :remove-uploaded-file-callback="removeUploadedFile"
        :remove-file-callback="remove"
        :progress="progress"
        :messages="messages">
        <FileUploadProgressBar v-if="hasFiles" :value="progress" :show-value="false" />
        <FileContent
          v-if="hasFiles"
          :files="files"
          :badge-value="pendingLabel"
          :preview-width="previewWidth"
          @remove="remove" />
        <FileContent
          :files="uploadedFiles"
          :badge-value="completedLabel"
...
export default {
  ...
  computed: {
    ...
    uploadDisabled() {
      return (
        this.disabled || !this.hasFiles || (this.fileLimit && this.fileLimit < this.files.length)
      );
    },
    cancelDisabled() {
